/*If you have completed the Tribonacci sequence kata, you would know by now that mister Fibonacci has at least a bigger
brother. If not, give it a quick look to get how things work.
        ...
        a bit more italian, but it would also sound really awful) with a signature of 5 elements and each following
...
public class XNbonacci {
    ...
    public static void main(String[] args) {
        XNbonacci xb = new XNbonacci();
        xb.xbonacci(new double[]{1, 1, 1, 1}, 10);
        xb.xbonacci(new double[]{0, 0, 0, 0, 1}, 10);
        xb.xbonacci(new double[]{1, 0, 0, 0, 0, 0, 1}, 10);
        xb.xbonacci(new double[]{1, 1}, 10);
    }
}
